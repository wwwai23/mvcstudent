...
<script type="text/javascript">
    ...
    function addRow() {
        ...
        cell1.innerHTML = '<input type="hidden" name="detailID">';
        cell2.innerHTML = '<input type="text" name="studentID">';
        cell3.innerHTML = '<input type="text" name="year">';
        cell4.innerHTML = '<input type="number" name="mark1">';
        cell5.innerHTML = '<input type="number" name="mark2">';
        cell6.innerHTML = '<input type="number" name="total" disabled>';
        cell7.innerHTML = '<input type="button" class="btn btn-danger" value="Delete" onClick="deleteRow(this)">';
    }
...
<body>
    ...
    <form id="studentForm" class="form-control">
        ...
        <div class="container">
            ...
            <% Logger logger = Logger.getLogger("MyLogger"); logger.setLevel(Level.ALL); %>
                ...
                <table class="table" id="detailTable">
                    ...
                    <tbody>
                        <% if (studentDetails != null) {
                            ...
                            <tr>
                                <td style="display:none;"><input type="hidden" name="detailID" value="<%=detail.getID()%>"></td>
                                <td><input type="text" class="border-0 bg-transparent" style="outline: none;" name="studentID" value="<%=detail.getStudentID()%>" readonly></td>
                                <td><input type="text" name="year" value="<%=detail.getYear()%>"></td>
                                <td><input type="number" name="mark1" value="<%=detail.getMark1()%>"></td>
                                <td><input type="number" name="mark2" value="<%=detail.getMark2()%>"></td>
                                <td><input type="number" name="total" value="<%=detail.getTotal()%>" disabled></td>
    ...
    <div class="d-flex justify-content-between mt-5 w-50">
                    <input type="submit" value="Save" onclick="setFormAction('/mvcstudent/c')"
                        class="btn btn-md btn-outline-primary"> 
                        
                        <input type="submit" value="Update" class="btn btn-md btn-outline-secondary" 
                        onclick="setFormAction('/mvcstudent/update/<%= student.getStudentID() %>')">
